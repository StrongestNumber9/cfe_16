...
public class TokenManagerTests {
    ...
    public void tokenCheckingTest() {
        ...
        Assertions.assertFalse(manager.tokenIsMissing(requestWithHttpHeaderAuth), "tokenIsMissing was expected to return false");
        Assertions.assertFalse(manager.tokenIsMissing(requestWithBasicAuth), "tokenIsMissing was expected to return false");
        Assertions.assertTrue(manager.tokenIsMissing(requestWithoutAuth), "tokenIsMissing was expected to return true");
    }
    ...
    public void basicAuthCheckingTest() {
        ...
        Assertions.assertTrue(manager.isTokenInBasic(basicAuthHeader), "Authorization wasn't in basic format");
        Assertions.assertFalse(manager.isTokenInBasic(authToken), "Authorization wasn't expected to be in basic format when querying with only the authentication token.");
    }
    ...
    public void getTokenFromBasicAuthTest() {
        ...
        Assertions.assertEquals(authToken, manager.getTokenFromBasic(basicAuthHeader), "Method should return the authentication token extracted from the Basic Authentication format");
    }
