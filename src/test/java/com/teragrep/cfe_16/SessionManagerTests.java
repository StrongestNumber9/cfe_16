...
public class SessionManagerTests {
    ...
    public void createSessionAndGetItWithAuthTokenTest() {
        ...
        Assertions.assertSame(session1, sessionManager.getSession(authToken1), "Got different session, should have received same");
        Assertions.assertSame(session2, sessionManager.getSession(authToken2), "Got different session, should have received same");
        Assertions.assertNotSame(session1, sessionManager.getSession(authToken2), "Got same session, should have received different");
        Assertions.assertNotSame(session2, sessionManager.getSession(authToken1), "Got same session, should have received different");
        Assertions.assertNull(sessionManager.getSession(authToken3), "Getting a session with an unused authentication token should return null");
    }
